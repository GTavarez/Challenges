...
def recommend_portfolio(intent_request):
    ...
    if risk_level == 'high':
        ...
        return close(
            ...
            'content': """Thank you for your information; The recommended portfolio for a {} level of risk is 20% bonds (AGG), 80% equities (SPY).""".format(risk_level)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your information; The recommended portfolio for a {} level of risk is 40% bonds (AGG), 60% equities (SPY).""".format(risk_level)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your information; The recommended portfolio for a {} level of risk is 60% bonds (AGG), 40% equities (SPY).""".format(risk_level)
            }
        )
        ...
        return close(
            ...
            {
            'contentType': 'PlainText',
            'content': """Thank you for your information; The recommended portfolio for a {} level of risk is 100% bonds (AGG), 0% equities (SPY).""".format(risk_level)
            }
        )
